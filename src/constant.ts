 ...
 */
// 佳明中国区账号及密码
export const GARMIN_USERNAME_DEFAULT = 'totti52110@163.com';
export const GARMIN_PASSWORD_DEFAULT = 'oukenshi19790622';
// 佳明国际区区账号及密码
export const GARMIN_GLOBAL_USERNAME_DEFAULT = 'totti52110@sina.com';
export const GARMIN_GLOBAL_PASSWORD_DEFAULT = 'oukenshi19790622';
// 佳明迁移数量配置
